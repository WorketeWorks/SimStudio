...
export const physicsengine_add_joint: (a: number, b: number, c: number) => void;
...
export const physicsengine_take_contact_pairs: (a: number, b: number) => void;
export const physicsengine_transform_stride: (a: number) => number;
