/* @ts-self-types="./sim_studio_physics.d.ts" */
...
export class PhysicsEngine {
    ...
    add_joint(joint) {
        try {
            ...
            wasm.physicsengine_add_joint(retptr, this.__wbg_ptr, addHeapObject(joint));
    ...
    constructor(scene) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.physicsengine_new(retptr, addHeapObject(scene));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    remove_joint(id) {
        ...
        const ret = wasm.physicsengine_remove_joint(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {any} gears
    ...
    replace_gears(gears) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.physicsengine_replace_gears(retptr, this.__wbg_ptr, addHeapObject(gears));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    set_excluded_collider_pairs(pairs) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.physicsengine_set_excluded_collider_pairs(retptr, this.__wbg_ptr, addHeapObject(pairs));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    stats() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.physicsengine_stats(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    step(delta_seconds, commands) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.physicsengine_step(retptr, this.__wbg_ptr, delta_seconds, addHeapObject(commands));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    take_contact_pairs() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.physicsengine_take_contact_pairs(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    transform_stride() {
        const ret = wasm.physicsengine_transform_stride(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./sim_studio_physics_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sim_studio_physics_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
