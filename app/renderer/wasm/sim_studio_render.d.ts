...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1237: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1251: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_311: (a: number, b: number, c: number) => void;
